      ...
      <section class="content">
         ...
         <div class="row">
              <div class="col-12">
                  <div class="card">
                      <div class="card-body">
                          <h4 class="header-title">User Directory</h4>
{{-- 
...
"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
    <path fill-rule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2Z"/>
                          ...
                          <ul class="nav nav-tabs nav-bordered mb-3" style="margin-top: 30px;">
                              <li class="nav-item">
                                  <a href="#bs-modals-admin" data-bs-toggle="tab" aria-expanded="false" class="nav-link active">
                                      Admin
                                  </a>
                              </li>
                              <li class="nav-item">
                                  <a href="#bs-modals-listers" data-bs-toggle="tab" aria-expanded="true" class="nav-link">
                                      Listers
                                  </a>
                              </li>
                              <li class="nav-item">
                          ...
                          <div class="tab-content">
                                ...
                                <div class="tab-pane show active" id="bs-modals-admin">
                                   <div class="col-md-12">
                                      <div class="row">
                                ...
                                <div class="tab-pane" id="bs-modals-listers">
                                    <div class="col-md-12">
                                        <div class="row">
                                          <div class="col-md-4">

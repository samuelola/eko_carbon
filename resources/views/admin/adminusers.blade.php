                  ...
                  <div class="card">
                      ...
                      <div class="card-body">
                          ...
                          <ul class="nav nav-tabs nav-bordered mb-3" style="margin-top: 30px;">
                              ...
                              <li class="nav-item">
                                <a href="#bs-modals-users" data-bs-toggle="tab" aria-expanded="true" class="nav-link">
                                    Users <span style="font-size: 11px;">({{ $ordinaryusers->count() ? $ordinaryusers->count() : 0 }})</span> 
                                </a>
                              </li>
                          ...
                          <div class="tab-content">
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            margin-bottom: 40px;">
                                                ...
                                                <ul class="dropdown-menu">
                                                  <li><a class="dropdown-item" id="hellolisters" href="#">Delete</a></li>
                                ...
                                <div class="tab-pane" id="bs-modals-offseters">
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <table id="examplelistersd" class="table table-hover display nowrap "style="width:100%">
                                                <thead>
                                                  <tr>
                                                      <th></th>
                                                      <th scope="col">Sn</th>
                                ...
                                <div class="tab-pane" id="bs-modals-users">
                                    <div class="col-md-12">
                                        <div class="row">
                                          
                                            <table id="exampleusersd" class="table table-hover display nowrap "style="width:100%">
                                                <thead>
                                                  <tr>
                                                    <th></th>
                                                    <th scope="col">First Name</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    $sn = 0;
                                                    @endphp
                                                    @foreach ($ordinaryusers as $theregistration)
                                                    <tr>
                                                        <td>{{ $theregistration->id }}</td>
...
<script>
    ...
    $(document).ready(function() {
tableuserr = $('#exampleusersd').DataTable( {
    dom: 'Bfrtip',
    responsive: true,
    buttons: [
        'csv', 'excel', 'pdf', 'print'
...
<script>
     $(document).ready(function() {
tablee = $('#examplelisters').DataTable( {
    dom: 'Bfrtip',
    responsive: true,
    buttons: [
        'csv', 'excel', 'pdf', 'print'

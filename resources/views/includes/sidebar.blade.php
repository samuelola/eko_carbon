                ...
                <li class="treeview">
				  ...
				  <ul class="treeview-menu">
						<li>
							...
							<?php
							$allprojects = App\Models\Project::where('user_id','=',Auth::user()->id)->take(3)->get();

							  foreach($allprojects as $value){

								?>
								  <li><a href="{{route('previewproject',$value->id) }}"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>{{ ucfirst($value->project_name) }}</a></li>
								<?php

                        ...
                        <form>
                            ...
                            <div class="form-group mb-30">
                                ...
                                <div class="mb-2">
                                    ...
                                    <p style="display: inline-flex;"><input type="radio" name="filter" class="filter" value="[0, 100000]"></p>
                                ...
                                <div class="mb-2">
                                    ...
                                    <p style="display: inline-flex;"><input type="radio" name="filter" class="filter" value="[100000, 200000]"></p>
                                ...
                                <div class="mb-2">
                                    ...
                                    <p style="display: inline-flex;"><input type="radio" name="filter" class="filter" value="[200000, 300000]"></p>
                                    <p style="display: inline;">200k-300k</p>
                                    
                                </div>
                                <div class="mb-2">
                            
                                    <p style="display: inline-flex;"><input type="radio" name="filter" class="filter" value="[300000, 400000]"></p>
                                    <p style="display: inline;">400k-500k</p>
                                    
                                </div>
                                <div class="mb-2">
                            
                                    <p style="display: inline-flex;"><input type="radio" name="filter" class="filter" value="[500000, 600000]"></p>
...
<script>
    $(document).on('click', '.filter', function(){
        ...
        // function table_post_roww(restt){

                    ...
                    <div class="col-lg-3 col-12">
                        ...
                        color: #fff;">
							<div class="box-body" style="padding-bottom: 20px !important;">
								{{-- <h4 class="box-title">Household Calculator</h4> --}}
								...
								<form action="#" class="form" id="forms" onsubmit="event.preventDefault()">
									...
									<div class="step-forms step-forms-active">
									  ...
									  <div class="form-group">
										...
										<input type="number" name="username" id="caladult" />
									  </div>
									  <div class="form-group">
									...
									<div class="step-forms">
									  ...
									  <div class="form-group">
										...
										<p style="display: flex;">
											<input style="width: 10% !important;" type="radio" name="username" id="carfuel1" value="fuel drinker" /><span >Fuel Drinker</span>
											<input style="width: 10% !important;" type="radio" name="username" id="carfuel2" value="average"/><span >Average</span>
											<input style="width: 10% !important;" type="radio" name="username" id="carfuel3" value="custom"/><span >Custom</span>
									  ...
									  <div class="form-group">
										...
										<p style="display: flex;">
											<input style="width: 10% !important;" type="radio" name="username" id="cardistancedriven1" value="less than 10 hours" /><span >Less than 10 hours</span>
											<input style="width: 10% !important;" type="radio" name="username" id="cardistancedriven2" value="15 hours"/><span >15 Hours</span>
											<input style="width: 10% !important;" type="radio" name="username" id="cardistancedriven3" value="custom"/><span >Custom</span>
									  ...
									  <div class="form-group">
										...
										<label for="email">Fuel Efficiency</label>
										<p style="display: flex;">
											<input style="width: 10% !important;" type="radio" name="username" id="carfuel11" value="fuel drinker" /><span >Fuel Drinker</span>
											<input style="width: 10% !important;" type="radio" name="username" id="carfuel12" value="average"/><span >Average</span>
											<input style="width: 10% !important;" type="radio" name="username" id="carfuel13" value="custom"/><span >Custom</span>
										
										</p>
									  </div>
									  <div class="form-group">
										<label for="email">How much distance does this car cover?</label>
										<input type="text" name="email" id="cover1" />
									  </div>
									  <div class="form-group">
										<label for="email"><b>Distance diven per week?</b></label>
										<p style="display: flex;">
											<input style="width: 10% !important;" type="radio" name="username" id="cardistancedriven21" value="less than 10 hours"/><span >Less than 10 hours</span>
											<input style="width: 10% !important;" type="radio" name="username" id="cardistancedriven22" value="15 hours"/><span >15 Hours</span>
											<input style="width: 10% !important;" type="radio" name="username" id="cardistancedriven23" value="custom"/><span >Custom</span>

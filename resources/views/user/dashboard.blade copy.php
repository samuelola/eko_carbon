	...
	function drawChart() {
	  var data = google.visualization.arrayToDataTable([
		...
		<?php 
         ...
         $menu = [];
		foreach($offsettersowner as $vv){
		
		  $menu[] =  $vv->project->project_name;
		 ...
		 foreach($offsetterspaymentsts as $uu){

             $oth[] = $uu->amount;
		 }

		 $cc = array_merge($menu,$oth);
		...
		//   echo $offseT->owner_id;
          
		//   $allproJ = [$offseT->count(),$listers->count(),$offsetters->count()];

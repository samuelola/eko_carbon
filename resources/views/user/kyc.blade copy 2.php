	  ...
	  <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <h3 style="margin-top: 50px;margin-left: 220px;
			">Bravo on creating your account</h3>
               <p style="margin-bottom:50px;margin-left: 170px;">We need these information to successfully profile your account</p>
		 ...
		 <!-- Step wizard -->
		  ...
		  <div class="box" style="margin-left: -180px;">
			...
			<div class="box-body wizard-content">
				<form action="#" method="post" class="tab-wizard wizard-circle" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<select class="form-select" id="countryy" name="country" >
								...
								<div class="form-group">
									...
									<input  id="mybank" type="number" class="form-control"  name="account_number" > 
								</div>
								...
								<div class="form-group">
									...
									<input id="myacctname" type="text" class="form-control" name="account_name"> 
								</div>
						...
						<div class="row">
                            ...
                            <div class="col-6">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="website" placeholder="http://" name="website">
								</div>
								...
								<div class="form-group">
									...
									<div class="c-inputs-stacked">
										...
										<textarea style="height: 91px;" class="form-control" name="summary" id="summary" cols="30" rows="10"></textarea>
									</div>
								</div>
							</div>
							<div class="col-3"></div>
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<select class="form-select" id="project_scope" name="project_scope">
										<option value="">Select---</option>
								...
								<div class="form-group">
									...
									<select class="form-select" id="business_owner" name="business_owner">
										<option value="">Select---</option>
								...
								<div class="form-group">
									...
									<select class="form-select" id="more" name="more">
										<option value="">Select---</option>
										<option value="Yes">Yes</option>
										<option value="No">No</option>
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="bus_fullname" name="bus_fullname" >
								</div>

								<div class="form-group">
									<label for="addressline12" class="form-label">Email Address:</label>
									<input type="text" id="bus_email" class="form-control" name="bus_email">
								</div>

								<div class="form-group">
									<label for="addressline13" class="form-label">Phone Number :</label><br/>
									{{-- <input type="text" class="form-control" id="addressline13"> --}}
									<input id="phone" style="width: 516px;" class="form-control" type="tel" name="phone" />
								</div>

								<div class="form-group">
									<label for="addressline12" class="form-label">Country:</label>
									 <select class="form-control" name="bus_country" id="bus_country">
								...
								<div class="form-group">
									<label for="addressline12" class="form-label">State:</label>
									 <select class="form-control" name="bus_state" id="bus_state">
								...
								<div class="form-group">
									<label for="addressline12" class="form-label">City:</label>
									 <select class="form-control" name="bus_city" id="bus_city">
								...
								<div class="form-group">
									...
									<select class="form-select" id="moreid" name="identity">
										<option value="">Select---</option>
										<option value="Voters Card">Voters Card</option>
										<option value="NIN">NIN</option>
										<option value="No">No</option>
		...
		<div class="modal-body p-30 bg-white">
		  ...
		  <div>
			  <div class="d-flex flex-row">
				  <div class=""><img src="/htmly/images/avatar/avatar-13.png" alt="user" class="rounded bg-primary-light w-150" width="100"></div>
				  <div class="ps-20">
...
<script>
    ...
    // alert('hello sam');
		...
		console.log(bus_fullname);
		console.log(bus_email);
		console.log(phone);
		console.log(bus_country);
		console.log(bus_state);
		console.log(bus_city);
		console.log(address);

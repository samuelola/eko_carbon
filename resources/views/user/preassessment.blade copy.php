                                        ...
                                        <div class="Recycle boxr">
                                            <form id="form11" class="ps-3 pe-3" action="#">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="phoneNumber1" class="form-label" style="color:#000">Metal:scraps(kg)</label>
                                                            <input type="number" class="form-control" id="metalscraps" name="metalscraps"> 
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="phoneNumber1" class="form-label" style="color:#000">Metal:Mixed Cans (kg)</label>
                                                            <input type="number" class="form-control" id="metalmixedcans" name="metalmixedcans"> 
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="phoneNumber1" class="form-label" style="color:#000">Electronic waste(kg)</label>
                                                            <input type="number" class="form-control" id="electronicwaste" name="electronicwaste"> 
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">

					...
					<div class="box" style="padding-bottom: 8px;">
						...
						<div class="box-body">
                            <div class="media">
                                  ...
                                  <div class="media-text">
      <p style="margin-top: 17px;color: #000;
	  font-weight: 500;margin-bottom: 0px;">Calculate & Offset my Personal Emissions</p>
	  <small style="padding-top: 0px;
	  font-size: 10px;
	  color: #000;">Calculate and offset your carbon Footprint</small>
                                  </div>
					...
					<div class="box" style="padding-bottom: 8px;">
						...
						<div class="box-body">
                            <div class="media">
                                  ...
                                  <div class="media-text">
      <p style="margin-top: 17px;color: #000;
	  font-weight: 500;margin-bottom: 0px;">Calculate & Offset my Organization's Emissions</p>
	  <small style="padding-top: 0px;
	  font-size: 10px;
	  color: #000;">Calculate and offset your carbon Footprint</small>
                                  </div>
